...
class MakeUseCaseCommand extends AbstractMaker
{
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator)
    {
        ...
        $testClassNameDetails = $generator->createClassNameDetails(
            ...
            'Gbelmans\\CodeChallenge\\Domain\\Tests',
            'Test'
        );

        $useCaseClassNameDetails = $generator->createClassNameDetails(
            $input->getArgument('name'),
            sprintf('Gbelmans\\CodeChallenge\\Domain\\%s\\UseCase', Str::asCamelCase($input->getArgument("domain"))),
            ''
        );

        $requestClassNameDetails = $generator->createClassNameDetails(
            $input->getArgument('name'),
            sprintf('Gbelmans\\CodeChallenge\\Domain\\%s\\Request', Str::asCamelCase($input->getArgument("domain"))),
            'Request'
        );

        $responseClassNameDetails = $generator->createClassNameDetails(
            $input->getArgument('name'),
            sprintf('Gbelmans\\CodeChallenge\\Domain\\%s\\Response', Str::asCamelCase($input->getArgument("domain"))),
            'Response'
        );

        $presenterClassNameDetails = $generator->createClassNameDetails(
            $input->getArgument('name'),
            sprintf('Gbelmans\\CodeChallenge\\Domain\\%s\\Presenter', Str::asCamelCase($input->getArgument("domain"))),
            'PresenterInterface'
        );
        ...
        $generator->generateFile(
            ...
            [
                ...
                "namespace" => sprintf(
                    'Gbelmans\\CodeChallenge\\Domain\\%s\\UseCase',
                    Str::asCamelCase($input->getArgument("domain"))
                ),
        ...
        $generator->generateFile(
            ...
            [
                ...
                "namespace" => sprintf(
                    'Gbelmans\\CodeChallenge\\Domain\\%s\\Request',
                    Str::asCamelCase($input->getArgument("domain"))
                )
            ]
        );
        ...
        $generator->generateFile(
            ...
            [
                ...
                "namespace" => sprintf(
                    'Gbelmans\\CodeChallenge\\Domain\\%s\\Response',
                    Str::asCamelCase($input->getArgument("domain"))
                )
            ]
        );
        ...
        $generator->generateFile(
            ...
            [
                ...
                "namespace" => sprintf(
                    'Gbelmans\\CodeChallenge\\Domain\\%s\\Presenter',
                    Str::asCamelCase($input->getArgument("domain"))
                ),
                'responseClassName' => $responseClassNameDetails->getShortName()
            ]
        ...
        $generator->generateFile(
            ...
            [
                ...
                "namespace" => sprintf(
                    'Gbelmans\\CodeChallenge\\Domain\\Tests\\%s',
                    Str::asCamelCase($input->getArgument("domain"))
                ),
